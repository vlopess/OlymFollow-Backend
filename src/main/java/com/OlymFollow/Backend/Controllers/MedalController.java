...
public class MedalController {
    ...
    public ResponseEntity<List<Country>> findAll() throws Exception {
        var medals = countryService.getAllCountries();
    ...
    public ResponseEntity<MedalDTO> findByCountryName(@PathVariable String countryName) throws Exception {
        var medals = countryService.getMedalByName(countryName);
        return ResponseEntity.ok(medals);
    }
